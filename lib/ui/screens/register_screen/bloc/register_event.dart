...
class RegistationCall extends RegisterEvent{
  // name, email, password, phoneNo, reference
  final String name;
  final String email;
  final String passwrod;
  final String phoneNo;
  final String reference;
  const RegistationCall({required this.name,required this.email, required this.passwrod,required this.phoneNo,required this.reference});
}